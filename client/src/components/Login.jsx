...
const Login = () => {
  ...
  const { logindata, setLogin, navegate } = useAppcontext();
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-100">
      ...
      >
        ...
        <button
          type="submit"
          className="mt-2 w-full h-11 rounded-full text-white bg-indigo-500 hover:opacity-90 transition-opacity mb-10"
        >
          Login
        </button>
      </form>
